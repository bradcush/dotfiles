" =============================================================================
" Filename: autoload/lightline/colorscheme/one_bradley.vim
" Author: Zoltan Dalmadi (Modified by Bradley Cushing)
" License: MIT License
" Last Change: 2020/05/15 23:05:00.
" =============================================================================
...
let s:p.normal.error  = [ [ s:bg, s:red1 ] ]
...
let g:lightline#colorscheme#one_bradley#palette = lightline#colorscheme#flatten(s:p)
